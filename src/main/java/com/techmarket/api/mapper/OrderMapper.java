...
public interface OrderMapper {
    ...
    @Mapping(source = "originalTotal",target = "originalTotal")
    @Mapping(source = "totalPriceVoucher",target = "totalPriceVoucher")
    @Mapping(source = "totalPriceSaleOff",target = "totalPriceSaleOff")
